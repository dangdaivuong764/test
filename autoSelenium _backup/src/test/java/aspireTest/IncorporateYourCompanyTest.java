...
public class IncorporateYourCompanyTest {
	 ...
	 */
	@Test
	public void testVerifyIncoporateCompany() throws Exception {
		RegistrationPages register = new RegistrationPages(driver);
		IncorporateYourCompanyPages incorporatecompany = validRegisterAndMobileOtpAndBussinessRoleStage(register);
		...
		waitAfterNavigateTo(1000);
		incorporatecompany.clickOnFirstPackages();
	}

	private IncorporateYourCompanyPages validRegisterAndMobileOtpAndBussinessRoleStage(RegistrationPages register) throws Exception {
